                        ...
                        child: ListView(
                          children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color: Palette.orange, width: 0.0)),
                                  child: Center(
                                      child: Text(
                                    "ADD CASH",
                                    style: TextStyle(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    t1[0],
                                    style: TextStyle(
                                        color: Palette.blue, fontSize: 15),
                                  ),
                                  Text(
                                    t2[0],
                                    style: TextStyle(
                            ...
                            Row(
                              ...
                              children: [
                                circularIcons('assets/images/rupee1.png',
                                    'Quick Refunds'),
                                circularIcons(
                                    'assets/images/tap.png', 'One-Tap payment'),
                                circularIcons('assets/images/badge.png',
                                    'Special Discounts'),
                              ],
                            ),
                          ],
